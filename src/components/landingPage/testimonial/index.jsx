 ...
 <p id={styles.testicol}>Testimonials</p>
      ...
      <div className={styles.TestCard}>
        <div className={styles.TestCards}>
          ...
          <div>
            <p className={styles.content}>
              I love Cue, this is the best place to plan your trip and find your
              dream holiday home.
            </p>
        ...
        <div className={styles.TestCards}>
          ...
          <div>
            <p className={styles.content}>Their security feature is top notch, i really liked it</p>
            <img src={stars} alt="" className={styles.stars} />
        ...
        <div className={styles.TestCards}>
          ...
          <div>
            <p className={styles.content}>
              As a family woman, this app helped me to plan all my trips on one
              go without any stress and all in the comfort of one app.
            </p>
